...
faq:
  ...
  - q: Does Core Web Vitals actually affect rankings?
    a: >-
      ...
      can hold a page back. The bigger reason to fix it is the conversion side —
      speed and stability move revenue directly, whatever the exact ranking
      weight.
...
I've watched this exact pattern on an enterprise ecommerce site: category pages averaging near a 10-second LCP, with cumulative layout shift sitting in the 0.3–0.5 range — deep in Google's "Poor" band on both. Everyone assumed it was the imagery. It wasn't.
