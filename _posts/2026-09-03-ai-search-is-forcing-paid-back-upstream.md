...
faq:
  - q: How is AI search affecting paid media?
    a: >-
      AI search is eroding the clickable placements that performance marketing
      depends on. As AI Overviews, Google's AI Mode, and LLM assistants answer
      queries directly, the click that search ads monetize happens less often —
      zero-click Google searches reached roughly 68% in early 2026, and AI
      Overviews cut click-through by around 60% where they appear. That shrinks
      the cheap bottom-of-funnel inventory paid media has leaned on, and pushes
      the durable advantage upstream toward brand and demand generation.
  - q: Is performance marketing dead?
    a: >-
      No, but the easy version of it is fading. The specific thing under
      pressure is cheap, abundant demand capture — intercepting existing intent
      through low-cost search and shopping clicks. That inventory is shrinking
      and getting more competitive as AI answers absorb the queries. Performance
      discipline still matters enormously; what's ending is the assumption that
      you can grow indefinitely by harvesting demand someone else created,
      because the harvesting surface itself is contracting.
  - q: Should we shift paid budget to brand and awareness?
    a: >-
      Increasingly, yes — but for a structural reason, not a fashionable one. If
      the capture layer is shrinking and commoditizing, the way to keep filling
      the funnel is to create more of the demand that flows into it, which is
      what brand and awareness investment does. The caveat is that upper-funnel
      spend can't be justified on a last-click report, so the shift only works
      if you also stand up incrementality measurement that can credit brand for
      the demand it generates.
  - q: Aren't ChatGPT ads and retail media just new performance channels?
    a: >-
      They are, and chasing them is the reflexive industry response — new
      surfaces to run the same demand-capture play on. That's not wrong, but
      it's re-fighting the last war. Those channels will commoditize the way
      search did, and whoever has the stronger brand will capture cheaper on
      them just as they did on Google. The more durable move is to invest in
      being the brand the AI recommends and the buyer already wants, so you win
      the new capture surfaces instead of just bidding on them.
  - q: How does GEO and AEO connect to paid media strategy?
    a: >-
      They're the same shift seen from the organic side. GEO and AEO are about
      being the brand an AI engine cites and recommends; brand-led paid is about
      being the brand a buyer already wants when they arrive. Both are responses
      to the same fact — that the neutral, cheap, click-through middle is
      collapsing, so being genuinely known and preferred matters more than being
      merely present. Paid and organic are converging on the same answer:
      create demand and earn preference, because intercepting it is getting
      harder.
---
...
The logic is direct. You can only capture as much demand as something upstream created, and the capture surfaces are getting more expensive and more crowded. So the leverage moves to being the brand a buyer already wants before they ever open a search box or an AI assistant — because when they do, they'll ask for you by name, and branded demand is the one kind of capture that stays cheap. This is the [demand-generation vs demand-capture](/blog/demand-generation-vs-demand-capture/) balance being forced by the market: for years the plan drifted toward capture because it was cheap and measurable. AI search is removing the "cheap" half of that, which changes the math.

## It's the same shift SEO is living through

None of this is separate from what's happening on the organic side. [GEO and AEO](/seo-aeo-geo/) — being the brand an AI engine cites and recommends — are the organic-side response to the exact same collapse of the neutral, clickable middle. Brand-led paid is the paid-side response. Both are answers to one fact: when the engine answers instead of routing, being genuinely *known and preferred* beats being merely *present and cheap*.

That's why I keep arguing paid and SEO are [one demand engine](/blog/one-demand-engine-measured-one-way/). They're converging on the same strategy from two directions — create demand, earn preference, become the brand the AI names and the buyer wants — because the era of cheaply intercepting demand you didn't build is closing on both of them at once.
...
So the shift to brand only survives if the [measurement](/paid-media/measurement/) moves with it: geo holdouts, matched-market tests, and media mix modeling that can credit demand generation for the demand it actually creates. Make that argument with incrementality, not attribution, or the strategy dies the way every under-measured brand budget has always died.
