...
faq:
  ...
  - q: How do I choose matched markets for an incrementality test?
    a: >-
      Pick test and control markets that behaved similarly before the test —
      similar baseline sales trend, seasonality, and ideally similar size and
  ...
  - q: How do I calculate incremental lift from a geo test?
    a: >-
      Establish what the test markets would have done without the media —
      usually by projecting their pre-period relationship to the control markets
