...
faq:
  - q: What is the difference between demand generation and demand capture?
    a: >-
      Demand capture converts intent that already exists, non-brand search,
      Shopping, retargeting, and branded search all intercept people who are
      already looking. Demand generation creates intent that wasn't there yet, CTV, online video, audio, paid social prospecting, and out-of-home
      introduce a need or a brand to people who weren't in-market. Capture
      harvests; generation plants. A healthy plan needs both, because you can
      only capture as much demand as something upstream created.
  - q: Why do companies over-invest in demand capture?
    a: >-
      Because it's cheap per conversion and easy to measure. Capture channels
      observe conversions well, so they report strong ROAS, and every efficiency
      review moves more budget toward them. The problem is that much of what they
      report is demand that already existed, they're taking credit for buyers
      who were sent looking by something upstream. Over time the plan becomes a
      pure harvesting operation that looks efficient while total demand shrinks.
  - q: How do I know if I'm under-investing in demand generation?
    a: >-
      Watch for flat or declining branded search and direct demand while your
      capture channels report healthy ROAS, that combination means you're
      efficiently harvesting a pool nobody is refilling. A holdout test on your
      capture channels that shows most of the revenue would have happened anyway
      is the harder confirmation: it means the capture spend isn't creating
      demand, so something else has to.
  - q: Can you measure demand generation?
    a: >-
      Yes, but not with last-click attribution, which is exactly why it gets
      cut. You measure it with geographic holdouts, matched-market tests, and
      media mix modeling, methods that read incremental lift rather than
      observed clicks. Brand-tracking signals like branded search volume, direct
      traffic, and survey lift corroborate it. The measurement is more work, and
      it's the only thing that keeps a generation budget from being killed on a
      report it was never going to win.
  - q: Is branded search demand generation or demand capture?
    a: >-
      Almost always capture, and often the most over-credited kind. A branded
      search is someone who already knows your name typing it in, the demand
      was created earlier, by upper-funnel media, organic presence, or a prior
      experience. Branded PPC captures that intent and reports it as revenue,
      which makes it look like a top performer when it's frequently intercepting
