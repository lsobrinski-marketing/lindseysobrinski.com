...
faq:
  - q: Is branded search incremental?
    a: >-
      Often only partially, and sometimes barely. Branded search intercepts
      people who already know your name and were looking for you, many would
      reach your site through the organic result if the ad weren't there. The
      incremental portion is the conversions the ad captured that organic
      wouldn't have, which depends on how dominant your organic listing is,
      whether competitors bid on your brand, and the layout of the results page.
      The reported ROAS almost always overstates the incremental truth.
  - q: Why does branded search show such high ROAS?
    a: >-
      Because it's the lowest-intent-distance spend in the account, it
      advertises to people actively searching for you by name. Those buyers
      convert at high rates whether or not they click the ad, and the campaign
      gets credited for all of them. High reported ROAS on branded search is a
      sign of high intent in the audience, not necessarily of high incremental
      value from the spend.
  - q: How do I test whether branded search is incremental?
    a: >-
      Run a holdout. Pause branded search entirely in a set of matched
      geographic markets while keeping it live in the rest, or pause it for
      defined time periods, and measure whether total branded conversions
      (paid plus organic) actually drop. If organic search absorbs most of the
      traffic when the ads go dark, the ad spend wasn't very incremental. The
      gap between reported ROAS and the holdout result is your over-investment.
  - q: Should I stop bidding on my own brand?
    a: >-
      Not necessarily, there are real reasons to keep some branded coverage,
      like competitors bidding on your name, controlling the message and
      landing page, or a weak organic listing. But those are specific,
      defensible reasons, not "the ROAS is great." Run the holdout, keep branded
      search funded where it's genuinely defending or capturing incremental
      demand, and stop paying for the clicks your organic result would win for
      free.
  - q: What does branded search reveal about demand generation?
    a: >-
      That branded demand is created upstream, not by the branded ad. Someone
      searching your brand by name was sent there by something, upper-funnel
      media, organic presence, word of mouth, a past purchase. Branded search
      captures that demand and reports it as revenue, which is why it's the
      clearest example of a capture channel taking credit for demand generation
      created elsewhere. It's the seam where the intent argument and the
      measurement argument meet.
---
...
This is the seam where the two halves of paid media meet. It's an [intent](/paid-media/intent/) question, a branded searcher is the highest-intent, lowest-distance-from-purchase person in your funnel, and it's a [measurement](/paid-media/measurement/) question, because whether the spend is *incremental* can only be settled with an experiment.
